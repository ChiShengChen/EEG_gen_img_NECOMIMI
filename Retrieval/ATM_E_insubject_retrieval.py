...
def main_train_loop(eeg_model, img_model, train_dataloader, test_dataloader, optimizer, device, 
    ...
    for epoch in range(config['epochs']):
        ...
        # if epoch%5 == 0:            
        #     torch.save(features_tensor, f"./models/sub-10_{epoch}.pt")  # Save features as .pt file
