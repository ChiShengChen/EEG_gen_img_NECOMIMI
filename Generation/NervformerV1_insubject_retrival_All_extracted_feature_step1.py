...
def get_eegfeatures(sub, eegmodel, dataloader, device, text_features_all, img_features_all, k):
    ...
    with torch.no_grad():
        ...
        if save_features:
            ...
            torch.save(features_tensor.cpu(), f"/home/aidan/EEG_Image_decode_old/Generation/NervformerV1_eeg_feature/{sub}/NervformerV1_eeg_features_{sub}_train.pt")  # Save features as .pt file
            
            # torch.save(features_tensor.cpu(), f"/home/aidan/EEG_Image_decode_old/Generation/NervformerV1_eeg_feature/{sub}/NervformerV1_eeg_features_{sub}_test.pt")  # Save features as .pt file
...
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-01/09-13_22-05/40.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-02/09-13_22-05/100.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-03/09-12_16-17/30.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-04/09-12_16-17/30.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-05/09-09_18-02/15.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-06/09-12_16-17/30.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-07/09-09_18-02/50.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-08/09-09_18-02/50.pth"))
# eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-09/09-09_18-02/15.pth"))
eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/NervFormerV1/sub-10/09-09_18-02/170.pth"))
