...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda') -> None:
        ...
        local_sdxlturbo_model_path = "/home/aidan/EEG_Image_decode_old/Generation/sdxl-turbo"
        pipe = DiffusionPipeline.from_pretrained(local_sdxlturbo_model_path, use_safetensors=True)
        ...
        ## load from local:
        pipe.load_ip_adapter(
            "/home/aidan/EEG_Image_decode_old/Generation/IP-Adapter", 
