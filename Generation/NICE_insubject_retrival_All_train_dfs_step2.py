...
sub = "sub-10"
emb_eeg = torch.load('/home/aidan/EEG_Image_decode_old/Generation/NICE_eeg_feature/'+ sub +'/NICE_eeg_features_'+ sub +'_train.pt')
emb_eeg_test = torch.load('/home/aidan/EEG_Image_decode_old/Generation/NICE_eeg_feature/'+ sub +'/NICE_eeg_features_'+ sub +'_test.pt')
...
for k in range(200):
    ...
    # display(image)
    image.save(f'./gen_images/NICE_sub10_generated_image_{k}_from_image_embeds.png')
    ...
    # display(image)
    image.save(f'./gen_images/NICE_sub10_generated_image_{k}_from_eeg_embeds.png')
    ...
    # display(image)
    image.save(f'./gen_images/NICE_sub10_generated_image_{k}_from_pipe_output.png')
