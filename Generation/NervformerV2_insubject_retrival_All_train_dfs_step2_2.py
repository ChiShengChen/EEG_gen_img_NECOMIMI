...
sub = "sub-01"
emb_eeg = torch.load('/home/aidan/EEG_Image_decode_old/Generation/NervformerV2_eeg_feature/'+ sub +'/NervformerV2_eeg_features_'+ sub +'_train.pt')
emb_eeg_test = torch.load('/home/aidan/EEG_Image_decode_old/Generation/NervformerV2_eeg_feature/'+ sub +'/NervformerV2_eeg_features_'+ sub +'_test.pt')
...
for k in range(200):
    ...
    # display(image)
    # image.save(f'./gen_images/Nerv2_sub01_generated_image_{k}_from_image_embeds.png')
    image.save(f'./gen_images/Nerv2_{sub}_generated_image_{k}_from_image_embeds_{seed_value}_ip1.png')
    ...
    # display(image)
    # image.save(f'./gen_images/Nerv2_sub01_generated_image_{k}_from_eeg_embeds.png')
    image.save(f'./gen_images/Nerv2_{sub}_generated_image_{k}_from_eeg_embeds_{seed_value}_ip1.png')
    ...
    # display(image)
    # image.save(f'./gen_images/Nerv2_sub01_generated_image_{k}_from_pipe_output.png')
    # image.save(f'./gen_images/Nerv2_{sub}_generated_image_{k}_from_pipe_output_{seed_value}.png')
    image.save(f'./gen_images/Nerv2_{sub}_generated_image_{k}_from_pipe_output_{seed_value}_ip1.png')
