...
def get_eegfeatures(sub, eegmodel, dataloader, device, text_features_all, img_features_all, k):
    ...
    with torch.no_grad():
        ...
        if save_features:
            ...
            torch.save(features_tensor.cpu(), f"/home/aidan/EEG_Image_decode_old/Generation/ATM_S_eeg_feature/{sub}/ATM_S_eeg_features_{sub}_test.pt")  # Save features as .pt file
...
test_dataset = EEGDataset("all", data_path, subjects= ['sub-10'], train=False)
...
eeg_model.load_state_dict(torch.load("/home/aidan/EEG_Image_decode_old/Retrieval/models/contrast/ATMS_50/sub-10/08-26_07-17/40.pth"))
eeg_model.to(device)
sub = 'sub-10'
